    ...
    >
      ...
      <div className=" shadow-md px-4 py-3 flex justify-start items-start">
        <div className="pl-3 sm:text-2xl font-bold flex items-center gap-4">
          <CgArrowsExpandUpLeft onClick={()=>Navigate("/ChatDesktop")} className={`hover:scale-90 transform transition-all duration-300  ${isLightMode?"text-black":"text-white"} cursor-pointer`}/>
